...
<body>
    ...
    <form id="form" method="post" action="CustomerDetails.php" onsubmit="return validateForm()">
        ...
        <fieldset>
            ...
            <label for="hdate">Joining Date</label>
            <input type="text" id="hdate" name="hdate" placeholder="abc1@hotmail.com"><br>

            <label for="hposition">Position</label>
            <input type="text" id="hposition" name="hposition" placeholder="+123456789"> <br>
        </fieldset>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email = filter_var($_POST["hdate"], FILTER_SANITIZE_EMAIL);
    $phone = filter_var($_POST["hposition"], FILTER_SANITIZE_STRING);
    ...
    $insert_sql = "INSERT INTO staff (Firstname, Lastname, Email, Phone, `Address`, City, `State`, Postcode) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
