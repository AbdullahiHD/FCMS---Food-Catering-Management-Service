            ...
            while ($row = $result->fetch_assoc()) {
                echo '<div class="order-div">';
                    echo '<div class="order-content">';
                        echo '<div class="order-title">Order #' . $row['OrderID'] . '</div>';
                        ...
                        echo '</div>';
                    echo '</div>';
                    echo '<div class="task-assignment" style="display: none;">Task Assignment System</div>';
                    echo '</div>';
                echo '</div>';
            ...
            orderDivs.forEach(function (orderDiv) {
                ...
                orderDiv.addEventListener('click', function () {
                    if (expanded) {
                        ...
                        orderDiv.style.minHeight = '250px';
                    }
                    expanded = !expanded;
                });
            });
